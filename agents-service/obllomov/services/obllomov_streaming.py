...
class ObLLoMov:
    ...
    async def generate_scene(
        ...
        total_steps = 8 if add_ceiling else 7
        current_step = 0
        ...
        if progress_callback:
            await progress_callback('floor', current_step, total_steps, scene_plan.to_scene(base_scene))
        ...
        current_step += 1
        if progress_callback:
            await progress_callback('walls', current_step, total_steps, scene_plan.to_scene(base_scene))
        ...
        current_step += 1
        if progress_callback:
            await progress_callback('doors', current_step, total_steps, scene_plan.to_scene(base_scene))
        ...
        current_step += 1
        if progress_callback:
            await progress_callback('windows', current_step, total_steps, scene_plan.to_scene(base_scene))
        ...
        current_step += 1
        if progress_callback:
            await progress_callback('object_selection', current_step, total_steps, scene_plan.to_scene(base_scene))
        ...
        current_step += 1
        if progress_callback:
            await progress_callback('floor_objects', current_step, total_steps, scene_plan.to_scene(base_scene))
        ...
        current_step += 1
        if progress_callback:
            await progress_callback('wall_objects', current_step, total_steps, scene_plan.to_scene(base_scene))
        ...
        if add_ceiling:
            ...
            current_step += 1
            if progress_callback:
                await progress_callback('ceiling', current_step, total_steps, scene_plan.to_scene(base_scene))
